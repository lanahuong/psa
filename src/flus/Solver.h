...
protected:
  double phi_norm_ =
      1; // The value to get back the real phi as we normalise the phi matrix
         // internally to deal with values close to 1.
  const double step_scale_ =
      1e-15; // femto, depends ont the inputs, shouldn't be changed without
