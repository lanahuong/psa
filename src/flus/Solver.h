...
protected:
    ...
    const double step_scale_ = 1e-10; //angstrom, depends ont the inputs, shouldn't be changed without changing the FRONTEND!!!!
    ...
    const double addition_scale = 10e-20;
    /**
...
public:
    ...
    double phitdt_norm() {
        return arma::accu(phitdt_ % arma::conj(phitdt_)).real() * dx_ * dy_ * phi_norm_ * phi_norm_ * step_scale_ * step_scale_;
    }
